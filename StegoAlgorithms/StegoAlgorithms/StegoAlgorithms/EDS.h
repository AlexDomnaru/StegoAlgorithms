...
void EDSdisembed(Mat stegoImage, int stegoKey) {
	...
	while (i < messageBits.size()) {
		...
		outfile << " " << letter.to_ulong() << " " << (uchar)letter.to_ulong();
		outfile << '\n';*/
